...
/// Create a minimalist premium mobile subscription screen for a wellness /
/// affirmations app.
///
/// Style: soft beige background, warm dark brown typography, muted sage green
/// accents. E
///
/// Layout (vertical):
///
...
/// Inside, a vertical timeline on the left (rounded green progress bar with
/// icons).
/// Steps on the right:
///
/// “Install the app” (completed, subtle strikethrough style)
/// “Set up goals”
///
/// “Today: Full access”
/// “Completely free for 3 days”
///
/// “Feb 25 – Reminder”
/// “When your trial is about to end”
///
/// “Feb 26 – Become a member”
/// “Your trial ends unless canceled”
///
/// Below card:
/// Toggle row:
/// “Remind me before trial ends” with rounded switch.
///
/// Primary CTA:
/// Full-width dark brown pill button:
/// “Start free trial”
///
/// Below:
/// Small centered pricing text:
/// “€4.16/month, billed annually at €49.99/year”
///
/// Footer links:
/// Terms – Restore Purchase – Privacy
///
/// Soft hierarchy, elegant spacing, subtle shadows, premium calm aesthetic.
...
class _PaywallWidgetState extends State<PaywallWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.fromSTEB(0.0, 70.0, 0.0, 60.0),
        child: Column(
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Paramétre-la pour tes objectifs',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Entièrement gratuit pendant tes 7 premiers jours',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'On te prévient 48h avant la fin de ton essai gratuit',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
