...
import 'paypaycompo_model.dart';
export 'paypaycompo_model.dart';

class PaypaycompoWidget extends StatefulWidget {
  const PaypaycompoWidget({super.key});

  @override
  State<PaypaycompoWidget> createState() => _PaypaycompoWidgetState();
}

class _PaypaycompoWidgetState extends State<PaypaycompoWidget> {
  late PaypaycompoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaypaycompoModel());
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.fromSTEB(0.0, 60.0, 0.0, 50.0),
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          'Personnalisation plus puissante grâce à l\'IA',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.poppins(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          'Plus d\'affirmations qui vous touchent',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.poppins(
                                      fontWeight: FlutterFlowTheme.of(context)
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          'Des catégories pour chaque situation',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.poppins(
                                      fontWeight: FlutterFlowTheme.of(context)
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Aucun paiement maintenant. Annule quand tu veux ',
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                _model.dadoupurchase =
                    await revenue_cat.purchasePackage('\$rc_annual');
                if (_model.dadoupurchase!) {
